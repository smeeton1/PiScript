...
def main():
    ...
    message4 = Text(Point(300, 15), 'North')
    message4.setTextColor('black')
    message4.setStyle('italic')
    message4.setSize(12)
    message4.draw(win)

    message5 = Text(Point(360, 15), 'CPU')
    ...
    while go:
        ...
        nort = Text(Point(300, 60), round(sense.get_compass(),1))
        nort.setTextColor('black')
        nort.setSize(15)
        nort.draw(win)

        cpu = Text(Point(360, 60), round(get_cpu_temp(),1))
